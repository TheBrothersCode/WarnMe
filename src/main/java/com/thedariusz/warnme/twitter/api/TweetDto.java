...
class TweetDto {
    ...
    public static TweetDto fakeTweet(String id, String creationDate, String twitterUserId, List<String> hashTags, String tweetText) {
        return new TweetDto(id, tweetText, AuthorDto.fake(twitterUserId), creationDate,  List.of("url1", "url2"), hashTags);
    }
